...
export async function build(opts: BuildOption) {
    console.log('build');
    ...
    const compiledConfig: CompiledConfig | null = fs.existsSync(compiledConfigPath)
...
export async function buildDeps(opts: any) {
